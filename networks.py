...
class temporalNetwork:
    ...
    def load(cls, dataset):
        ...
        if dataset == 'high school2':
            #edgelist = np.loadtxt("../1 data/high school/High-School_data_2013.csv", delimiter=" ", dtype=int, usecols=(0,1,2))

            import pandas as pd
            edgelist = pd.read_csv("../1 data/high school 2/full.txt", sep="\t", header=None)
            ...
            roles = pd.read_csv("../1 data/high school 2/roles.txt", sep="\t", header=None)
            role_map = {
                x[0]: x[1]
            ...
            import pandas as pd
            edgelist = pd.read_csv("../1 data/high school/High-School_data_2013.csv", sep=" ", header=None)
            ...
            import pandas as pd
            edgelist = pd.read_csv("../1 data/contacts in the workplace/tij_InVS.DAT", sep=" ", header=None)
            edgelist = np.array(edgelist)

            time_start = dt.datetime(2013,6,24).timestamp()

            depts = pd.read_csv("../1 data/contacts in the workplace/metadata_InVS13.TXT", sep="\t", header=None)
            ...
            import pandas as pd
            edgelist = pd.read_csv("../1 data/contacts in the workplace 2/tij_InVS15.DAT", sep=" ", header=None)
            edgelist = np.array(edgelist)
            ...
            import pandas as pd
            edgelist = pd.read_csv("../1 data/primary school/primaryschool.csv", sep="\t", header=None)
            edgelist = np.array(edgelist)

            time_start = dt.datetime(2009,10,1, 7,0,0).timestamp()

            depts = pd.read_csv("../1 data/primary school/metadata_primaryschool.txt", sep="\t", header=None)
            ...
            import pandas as pd
            edgelist = pd.read_csv("./TemporalGillespieAlgorithm/sampleData.txt", sep="\t", header=None)
            edgelist = np.array(edgelist)
